...
public class ZooManagement {
    public static void main(String[] args) throws ZooFullException {
        ...
        Zoo myZoo= new Zoo("Carthage Zoo", "Tunis",0,3);
        Animal a = new Animal("Flipper", "Delphinidae", -1, true);
        Animal b = new Animal();
        Animal c = new Animal();
        Animal d = new Animal();

        try{
            if (myZoo.getNbrAnimals()<myZoo.getNbrCages()){
                myZoo.addAnimal(a);
                myZoo.addAnimal(b);
                //myZoo.addAnimal(c);
                //myZoo.addAnimal(d);
                ...
                throw new ZooFullException("Zoo full dsl");
            }
